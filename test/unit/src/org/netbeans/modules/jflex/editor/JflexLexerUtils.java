 ...
 * @author bhaidu
 */
public class JflexLexerUtils extends TestCase {
    
    public static class LexerResultItem {
        private JflexTokenId tokenId;
        private String text;

        public LexerResultItem(JflexTokenId tokenId, String text) {
         ...
         * @return the tokenId
         */
        public JflexTokenId getTokenId() {
            return tokenId;
        }
    ...
    public static void next(TokenSequence<?> ts, TokenId id, String fixedText) {
        ...
        //assertEquals(JflexTokenId.T_HTML, id);
        assertEquals(fixedText, ts.token().text());
        ...
        while (line != null) {
            if (line.startsWith("#->[")) {
                ...
                if (index > 0) {
                    ...
                    resultItem = new LexerResultItem(JflexTokenId.valueOf(tokenIdName), text);
